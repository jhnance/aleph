...
- `GET /api/search?q=<query>` returns results across points, domains, and use cases within the current org; requires an authenticated session with an active org
